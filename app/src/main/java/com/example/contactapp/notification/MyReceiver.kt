...
//    // 앱 종료하면 이것도 날아가고 매니저도 날아감. 매니저를 리시버에서 새로 만들어줘야할듯.
//    companion object {
...
//    }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        // 앱 종료 후에 리시버 받았을 때 푸시알림 하려면 매니저를 새로 만들어야 한다.
        val manager = MyManagers.makeNotificationManager(context)
...
//        // 알람 설정해두고 앱 종료하면, 노티 매니저, 세이브드노티 다 날아간다.
